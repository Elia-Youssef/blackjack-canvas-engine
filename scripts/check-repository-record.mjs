...
if (process.env.PULL_REQUEST_BODY) {
  // A dependency branch's pull request body is generated by the update
  ...
  // surface on dependency branches; the title, the branch name, the commit
  // messages and every tracked file are still scanned there.
  if (!dependencyBranch) {
